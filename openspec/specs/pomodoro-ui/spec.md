...
**Purpose:** Visual design and layout of the Pomodoro application — brand-themed colour palettes (Chupa Chups and Coca-Cola), mode theming, countdown display, control buttons, brand-specific decorative SVG, and responsive layout.
