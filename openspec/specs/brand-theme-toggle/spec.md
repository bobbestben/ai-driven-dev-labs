...
**Purpose:** Toggle between Chupa Chups and Coca-Cola brand themes — includes the toggle control, brand-appropriate colour palettes, theme-specific SVG decorations, and `localStorage` persistence.
