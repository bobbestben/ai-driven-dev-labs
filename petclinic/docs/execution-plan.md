...
- Create a PetRepository with a findByName method which returns a single result. Create a PetService that calls the PetRepository and only includes find, findAll and save methods
